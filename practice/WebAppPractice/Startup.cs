...
namespace WebAppPractice
{
    public class Startup
    {
        ...
        public void ConfigureContainer(ContainerBuilder builder)
        {
            ...
            builder
                .RegisterModule(new ClassRoomModule(connectionString, migrationAssemblyName));
        }

       /* public void checkStartup()
        {
            var instance = AutofacContainer.Resolve<PracticeContext>();
            Program.checkProgram(instance);
        }*/
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            app.UseEndpoints(endpoints =>
            {
                endpoints.MapControllerRoute(
                  name: "areas",
                  pattern: "{area:exists}/{controller=ClassRoom}/{action=Index}/{id?}"
                );
