...
using RacingCompetition.RacingData;
...
namespace RacingCompetition
{
    public class Startup
    {
        ...
        public void ConfigureContainer(ContainerBuilder builder)
        {
            ...
            builder.RegisterModule(new RacingDataModule(connectionInfo.connectionString,
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<RacingDataContext>(options =>
                options.UseSqlServer(connectionInfo.connectionString, b =>
                b.MigrationsAssembly(connectionInfo.migrationAssemblyName)));
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            app.UseEndpoints(endpoints =>
            {
                ...
                endpoints.MapControllerRoute(
                    name: "default",
                    pattern: "{area=Admin}/{controller=Player}/{action=Index}/{id?}");
